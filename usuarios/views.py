...
def tarefa_cadastro(request, pk, template_name="tarefa_cadastro.html"):
    ...
    context = {'form': tarefa, 'membro_list':membro, 'categoria_list':categoria, 'projeto':projeto, "menu":"projetos"}
    return render(request, template_name, context)
...
def tarefa_editar(request, pk, template_name="tarefa_editar.html"):
    ...
    context = {'membro_list': membro, 'categoria_list': categoria, 'projeto': projeto, 'tarefa':tarefa, 'data_limite_tratada':data_limite_tratada, "menu":"projetos"}
    return render(request, template_name, context)
...
def projeto_visao(request, pk, template_name="visao_projeto.html"):
    ...
    context = {'projeto': projeto, 'tarefas': tarefas, 'categorias': categoria, 'template': "visao_projeto",  "menu":"projetos" }
    return render(request, template_name, context)
...
def tarefas_do_usuario_projeto(request, pk, template_name="visao_projeto.html"):
    ...
    context = {'projeto': projeto, 'tarefas': tarefas, 'categorias': categoria, 'template': "visao_projeto_tarefa",  "menu":"projetos" }
    return render(request, template_name, context)
